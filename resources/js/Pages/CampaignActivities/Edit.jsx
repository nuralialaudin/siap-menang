...
export default function Edit({ auth, activity, zones }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('campaign-activities.update', activity.id));
    };

    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800">Edit Aktivitas Kampanye</h2>}>
